    ...
    <>
      ...
      <main className={`${styles.main}`}>
        ...
        <div className={`${styles.cardRight}`}>
          ...
          <Card title='Interests' description='Badminton (and other sports), Books, Movies, Music (kpop), flower arrangements, cooking, story writer, and any kind of restaurant job'/>
        </div>
        </div>
